...
import 'package:ecommerce_server/src/generated/product.dart' as _i6;
import 'package:ecommerce_server/src/generated/order.dart' as _i7;
export 'example.dart';
export 'order.dart';
export 'product.dart';
...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    if (t == List<_i7.Order>) {
      return (data as List).map((e) => deserialize<_i7.Order>(e)).toList()
          as dynamic;
    }
    try {
